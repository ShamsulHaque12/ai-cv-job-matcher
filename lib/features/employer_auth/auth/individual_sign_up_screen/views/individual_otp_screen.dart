...
class IndividualOtpScreen extends StatelessWidget {
  final IndividualOtpController controller = Get.put(IndividualOtpController());
  final String email;
  IndividualOtpScreen({super.key, required this.email});
    ...
    showDialog(
      ...
      builder: (context) {
        Future.delayed(Duration(seconds: 3), () {
          controller.verifyIndividualOtp(controller.pinController.text.trim());
        });
        return Dialog(
