...
class AllInactiveScreenView extends GetView<AllInactiveScreenController> {
  ...
  AllInactiveScreenView({super.key});
  @override
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              Obx(() {
                if (requirmentScreenController.inactiveJobPosts.isEmpty) {
                  return Center(
                    child: Text(
                      "No Jobs Found!",
                ...
                return ListView.separated(
                  ...
                  itemCount: requirmentScreenController.inactiveJobPosts.length,
                  separatorBuilder: (_, __) => SizedBox(height: 12.h),
                  itemBuilder: (context, index) {
                    final jobs = requirmentScreenController.inactiveJobPosts[index];
