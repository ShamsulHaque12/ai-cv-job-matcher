...
class EditRequirmentScreenView extends GetView<EditRequirmentScreenController> {
  const EditRequirmentScreenView( {super.key});
        ...
        child: Column(
          children: [
            ...
            CustomTextField(
              ...
              isDropdown: true,
              dropdownItems: ["ACTIVE", "DELETED", "SUSPENDED"],
